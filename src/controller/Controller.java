...
public class Controller {
	...
	//public static final List<Evaluator> evaluators = new getAvailableInstances(Evaluator.class);

	private static final List<Player> players = getAvailableInstances(ai.Player.class);
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			while (!moves.isEmpty()) {
				...
				if (time>=80||move == null) { //TODO changed this line
					//board.timeTrialMove();
					System.out.println("too long");
					board.move(board.getMoves().get(0));
				} else {
					board.move(move);
				}
...
//		// System.out.println(paths.length);
//		for (int i = paths.length - 1; !paths[i].equals("2048"); i--) {
